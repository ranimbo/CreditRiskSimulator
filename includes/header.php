 ...
 * 
 * Navbar navy #003366, logo Amen Bank, accent gold #C8971F.
 * Inclut Tailwind CSS, Chart.js, navigation et menu utilisateur.
 */
        ...
        <nav class="navbar-amen">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <a href="dashboard.php" class="flex items-center gap-3">
                                <img src="assets/images/logo_amen_bank.png" 
                                     alt="Amen Bank" 
                        ...
                        <div class="hidden md:ml-8 md:flex md:items-center md:space-x-1">
                            ...
                            <a href="clients.php" class="nav-link <?php echo ($currentPage === 'clients' || $currentPage === 'client-form') ? 'active' : ''; ?>">
                                <i data-feather="users" class="w-4 h-4"></i>
                                Clients
                            </a>
                            <a href="simulation.php" class="nav-link <?php echo $currentPage === 'simulation' ? 'active' : ''; ?>">
                            ...
                            <?php if (isAdmin()): ?>
                            <a href="admin/index.php" class="nav-link <?php echo strpos($currentPage, 'admin') !== false ? 'active' : ''; ?>">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <!-- User Dropdown -->
                        <div class="relative">
                            <button type="button" onclick="toggleUserMenu()" class="flex items-center gap-2 text-sm focus:outline-none" id="user-menu-button">
                            ...
                            <div id="user-menu" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl py-1 ring-1 ring-black/5 z-50">
                                ...
                                <a href="logout.php" class="flex items-center gap-2 px-4 py-2.5 text-sm text-[#C0392B] hover:bg-red-50 transition-colors">
                        ...
                        <div class="flex items-center md:hidden">
                            <button type="button" onclick="toggleMobileMenu()" class="p-2 rounded-lg text-white/70 hover:text-white hover:bg-white/10">
            ...
            <div id="mobile-menu" class="hidden md:hidden border-t border-white/10">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    <a href="dashboard.php" class="<?php echo $currentPage === 'dashboard' ? 'bg-white/10 text-white' : 'text-white/70'; ?> block px-3 py-2 rounded-lg text-base font-medium flex items-center gap-3">
                        <i data-feather="grid" class="w-4 h-4"></i>
                        Tableau de bord
                    </a>
                    <a href="clients.php" class="<?php echo $currentPage === 'clients' ? 'bg-white/10 text-white' : 'text-white/70'; ?> block px-3 py-2 rounded-lg text-base font-medium flex items-center gap-3">
                        <i data-feather="users" class="w-4 h-4"></i>
                        Clients
                    </a>
                    <a href="simulation.php" class="<?php echo $currentPage === 'simulation' ? 'bg-white/10 text-white' : 'text-white/70'; ?> block px-3 py-2 rounded-lg text-base font-medium flex items-center gap-3">
                        <i data-feather="calculator" class="w-4 h-4"></i>
                        Simulations
                    </a>
                    <a href="history.php" class="<?php echo $currentPage === 'history' ? 'bg-white/10 text-white' : 'text-white/70'; ?> block px-3 py-2 rounded-lg text-base font-medium flex items-center gap-3">
                        <i data-feather="clock" class="w-4 h-4"></i>
                        Historique
                    </a>
                    <?php if (isAdmin()): ?>
                    <a href="admin/index.php" class="text-white/70 block px-3 py-2 rounded-lg text-base font-medium flex items-center gap-3">
                        <i data-feather="settings" class="w-4 h-4"></i>
                        Administration
                    </a>
                    <?php endif; ?>
